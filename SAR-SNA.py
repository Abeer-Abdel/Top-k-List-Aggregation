...
def kendall_p_ties_between(pos1, pos2, p):
    ...
    for i, j in itertools.combinations(universe, 2):
        ...
        # One list has tie, other missing one item
...
# Run Hybrid SAR–SNA
print("\nHybrid SAR–SNA (avg rank ↑, then freq ↓)")
key_h = lambda x: (avg_rank.get(x, math.inf), -freq_counts[x])
